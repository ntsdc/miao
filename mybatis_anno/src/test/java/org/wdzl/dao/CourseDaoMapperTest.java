...
public class CourseDaoMapperTest {
    private InputStream inputStream = null;
    private SqlSessionFactory factory = null;
    private SqlSession sqlSession1 = null;

    private CourseDaoMapper mapper = null;
    ...
    public void init() throws Exception{
        ...
        mapper = sqlSession1.getMapper(CourseDaoMapper.class);

    }

//    @Test
//    public void ManyOneToMany(){
//        List<Student> students = mapper.findCoursesBySid()
//
//    }
